(function (global) {
    ...
    const phraseMap = {
        ...
        'it': {
            ...
            '21-dniowy streak bez przerwy': 'Serie di 21 giorni senza pausa',
            '30-dniowy wojownik': 'Guerriero di 30 giorni',
            '7-dniowa passa treningowa': 'Serie di allenamenti di 7 giorni',
            'Aktywny (10K)': 'Attivo (10K)',
            'Bestia treningu': 'Bestia dell\'allenamento',
            'Bieg / aktywność': 'Corsa / attività',
            'Biegacz (50K)': 'Corridore (50K)',
            'Bieganie': 'Corsa',
            'Bohater nawodnienia': 'Eroe dell\'idratazione',
            'Brak': 'Nessuno',
            'Brak danych biegu dziś – wpisz dystans i czas.': 'Nessun dato di corsa oggi - inserisci distanza e tempo.',
            ...
            'Brak wybranych partii – kliknij, aby zaznaczyć dziś trening.': 'Nessuna parte del corpo selezionata - clicca per segnare l\'allenamento di oggi.',
            'Budzik': 'Sveglia',
            'Bumblebee': 'Bumblebee',
            'Całkowity cel godzin nauki do osiągnięcia przez całe wyzwanie': 'Obiettivo totale di ore di studio per tutta la sfida',
            'Całkowity cel kroków do osiągnięcia przez całe wyzwanie': 'Obiettivo totale di passi per tutta la sfida',
            'Całkowity cel workoutów do zrobienia przez całe wyzwanie': 'Obiettivo totale di allenamenti per tutta la sfida',
            'Cel godzin nauki:': 'Obiettivo ore di studio:',
            'Cel kroków:': 'Obiettivo passi:',
            'Cel workoutów:': 'Obiettivo allenamenti:',
            'Do zrobienia': 'Da fare',
            'Dodaj': 'Aggiungi',
            'Dodaj 25 zdjęć do galerii': 'Aggiungi 25 foto alla galleria',
            ...
            'Kliknij, aby zagrać': 'Clicca per riprodurre',
            'Kolekcjoner legend': 'Collezionista di leggende',
            'Król powrotu': 'Re del ritorno',
            'Legenda 75 Hard': 'Leggenda 75 Hard',
            'Legenda fitnessu': 'Leggenda del fitness',
            'Legenda kroków (250K)': 'Leggenda dei passi (250K)',
            'Legendarny wykonawca': 'Esecutore leggendario',
            'Liczyć dni odpoczynku jako ukończone': 'Conta i giorni di riposo come completati',
            'Maratończyk (100K)': 'Maratoneta (100K)',
            'Megatron': 'Megatron',
            'Miesięczny mistrz': 'Maestro mensile',
            'Mistrz dyscypliny': 'Maestro della disciplina',
            'Mistrz emocji': 'Maestro delle emozioni',
            'Mistrz kolorów': 'Maestro dei colori',
            'Mistrz konsystencji': 'Campione della costanza',
            'Mistrz wyzwania': 'Campione della sfida',
            'Mistrz zadań': 'Maestro dei compiti',
            'Motyl społeczny': 'Farfalla sociale',
            'Motywacja': 'Motivazione',
            'Mroczny rycerz': 'Cavaliere oscuro',
            ...
            'Odkrywca stylów': 'Esploratore di stili',
            'Odznaki zdobyte 🏆': 'Badge ottenuti 🏆',
            'Odzyskaj streak po jego zerwaniu': 'Recupera la serie dopo averla interrotta',
            'One Punch': 'One Punch',
            'Optimus Prime': 'Optimus Prime',
            'Osiągnij 50-dniowy streak': 'Raggiungi una serie di 50 giorni',
            'Otwórz': 'Apri',
            'Perfekcjonista': 'Perfezionista',
            'Pierwsza chwila': 'Primo momento',
            'Pierwsze kroki': 'Primi passi',
            'Pierwsze kroki (5K)': 'Primi passi (5K)',
            'Pierwsze wrażenie': 'Prima impressione',
            'Plus Ultra!': 'Plus Ultra!',
            ...
            'Pobierz pełny raport ze statystykami': 'Scarica il report completo con le statistiche',
            'Początkujący': 'Principiante',
            'Początkujący atleta': 'Atleta principiante',
            'Początkujący wojownik': 'Guerriero principiante',
            'Podróżnik w czasie': 'Viaggiatore nel tempo',
            ...
            'Powrót': 'Indietro',
            'Promyk słońca': 'Raggio di sole',
            'Przebiegnij 500,000 kroków łącznie': 'Raggiungi 500.000 passi totali',
            'Przed rozpoczęciem wyzwania musisz zaakceptować zasady': 'Prima di iniziare la sfida devi accettare le regole',
            'Przekrocz własne limity - 60-dniowy streak': 'Supera i tuoi limiti - serie di 60 giorni',
            'Rocky Balboa': 'Rocky Balboa',
            'Rozciąganie': 'Stretching',
            'Siłownia': 'Palestra',
            'Siłownia / partie ciała': 'Palestra / parti del corpo',
            'Startowy ogień': 'Fuoco iniziale',
            'Strażnik wspomnień': 'Custode dei ricordi',
            ...
            'Tygodniowy płomień': 'Fiamma settimanale',
            'Ukończ 10 dni bez przegapienia żadnego zadania': 'Completa 10 giorni senza saltare nessun compito',
            'Ukończ 10 treningów': 'Completa 10 allenamenti',
            'Ukończ 100 treningów': 'Completa 100 allenamenti',
            'Ukończ 15 dni wyzwania': 'Completa 15 giorni della sfida',
            'Ukończ 30 dni wyzwania': 'Completa 30 giorni della sfida',
            'Ukończ 30 treningów': 'Completa 30 allenamenti',
            'Ukończ 50 dni bez przegapienia zadań': 'Completa 50 giorni senza saltare compiti',
            'Ukończ 50 dni wyzwania': 'Completa 50 giorni della sfida',
            'Ukończ 75 treningów': 'Completa 75 allenamenti',
            'Ukończ pierwszy trening': 'Completa il tuo primo allenamento',
            'Ukończ wszystkie 75 dni!': 'Completa tutti i 75 giorni!',
            'Ukończone dziś': 'Completato oggi',
            'Ukończono dziś': 'Completato oggi',
            'Ukończono dziś zadań treningowych. Możesz oznaczać gotowe filmy i ćwiczenia jednym kliknięciem.': 'Compiti di allenamento completati oggi. Puoi segnare video ed esercizi finiti con un clic.',
            'Ultra Instinct': 'Ultra Istinto',
            'Usuń': 'Elimina',
            'Użyj motywu Transformers': 'Usa il tema Transformers',
            'Użyj trybu ciemnego': 'Usa la modalità scura',
            'Wklej link do YouTube z ćwiczeniami i przypisz kategorię dla lepszego porządku.': 'Incolla un link YouTube con esercizi e assegna una categoria per una migliore organizzazione.',
            'Wojownik siłowni': 'Guerriero della palestra',
            'Wojownik weekendu': 'Guerriero del weekend',
            'Workouty - Zarządzanie': 'Allenamenti - Gestione',
            'Workouty wyłączone. Włącz je w ustawieniach!': 'Allenamenti disattivati. Attivali nelle impostazioni!',
            'Wszystkie': 'Tutti',
            'Wybierz partie, które dziś ćwiczyłaś i od razu zobaczysz swój plan w jednym miejscu.': 'Scegli le parti del corpo allenate oggi e vedi il tuo piano in un unico posto.',
            'Wybrane partie:': 'Parti selezionate:',
            'Wypróbuj 5 różnych motywów': 'Prova 5 temi diversi',
            'Wypróbuj wszystkie motywy': 'Prova tutti i temi',
            ...
            'Włącz kroki': 'Attiva passi',
            'Włącz naukę': 'Attiva studio',
            'Włącz workouty': 'Attiva allenamenti',
            ...
            'Zapisuj dane o różnych porach dnia': 'Registra dati in diversi momenti della giornata',
            'Zapisuj dane przez 14 dni z rzędu': 'Registra dati per 14 giorni di fila',
            'Zapisz 30 dni z 1L+ wody': 'Registra 30 giorni con 1L+ di acqua',
            'Zapisz bieg': 'Salva corsa',
            'Zapisz dzisiejszy bieg, czas i rekord, a aplikacja pokaże Ci, jak wygląda Twój progres.': 'Salva la corsa di oggi, il tempo e il record, e l\'app ti mostrerà i tuoi progressi.',
            'Zapisz wszystkie 5 typów nastroju': 'Registra tutti e 5 i tipi di umore',
            ...
            'Zdobądź 50 odznak': 'Ottieni 50 badge',
            'Zmień motyw na czerwony i osiągnij 30-dniowy streak': 'Passa al tema rosso e raggiungi una serie di 30 giorni',
            'Zmień motyw na czerwony lub fioletowy': 'Passa al tema rosso o viola',
            'Zmień motyw na żółty': 'Passa al tema giallo',
            'Zrób dziś': 'Fai oggi',
            ...
            'na Mac': 'su Mac',
            'z zaplanowanych zadań treningowych. Kliknij „Zrób dziś" albo checkbox, aby śledzić progres.': 'dei compiti di allenamento pianificati. Clicca "Fai oggi" o la casella per tracciare i progressi.',
            'Ćwicz w sobotę i niedzielę': 'Allenati sabato e domenica',
            'Łowca nastrojów': 'Cacciatore d\'umore',
            'Żelazne zaangażowanie': 'Dedizione di ferro',
        }
    };
