(function (global) {
    ...
    const phraseMap = {
        ...
        'en': {
            ...
            'Dzień': 'Day',
            'Odznak': 'Badges',
            'Zaatakuj dzień!': 'Take on the day!',
            'Zapisz i zacznij dzień': 'Save and start the day',
            'Twoja odpowiedź...': 'Your answer...',
            'słów': 'words',
            '⚠️ Refleksja może mieć maksymalnie 100 słów.': '⚠️ A reflection can have up to 100 words.',
            'Status': 'Status',
            'Zadania': 'Tasks',
            'tak': 'yes',
            'nie': 'no',
            'Refleksja': 'Reflection',
            'Zapisz refleksję': 'Save reflection',
            'Anuluj': 'Cancel',
            'Nie masz jeszcze zapisanych wcześniejszych wyzwań.': 'You do not have any archived challenges yet.',
            'dni': 'days',
            'Najlepszy streak': 'Best streak',
            'Refleksje': 'Reflections',
            'Usuń z archiwum': 'Delete from archive',
            'Usunąć to wyzwanie z archiwum?': 'Delete this challenge from the archive?',
            'ukończony': 'complete',
            'częściowy': 'partial',
            'odpoczynek': 'rest',
            'nieudany': 'missed',
            ...
            'Wyzwanie': 'Challenge',
            'Regularność buduje mocny postęp. Każdy dzień robi różnicę, gdy masz plan i widoczny wynik.': 'Consistency builds real momentum. Every day makes a difference when you have a plan and visible results.',
            ...
            'dni': 'days',
            'Trening bez filmu': 'Workout without video',
            'Dodaj trening': 'Add workout',
            'Zaznacz checkbox, gdy będzie wykonany.': 'Check the box when it is done.',
            'Bieg / aktywność bez filmu': 'Run / activity without video',
            'Dystans:': 'Distance:',
            'Czas:': 'Time:',
            'Np. Bieg 5 km, interwały, rower...': 'E.g. 5 km run, intervals, bike...',
            'Wpisz nazwę treningu!': 'Enter workout name!',
            'Wpisz dystans lub czas biegu': 'Enter run distance or time',
            'Bieg zapisany i dodany do workoutów!': 'Run saved and added to workouts!',
            'Trening bez filmu dodany do listy. Zaznacz checkbox, gdy będzie wykonany.': 'Workout without video added to the list. Check the box when it is done.',
            'Kliknij, aby zagrać': 'Click to play',
            'Bieg / aktywność': 'Run / activity',
            'Zapisz dzisiejszy bieg, czas i rekord, a aplikacja pokaże Ci, jak wygląda Twój progres.': 'Save today\'s run, time and record, and the app will show your progress.',
            'Zrób dziś': 'Do today',
            ...
            '✅ Trening bez filmu dodany do listy. Zaznacz checkbox, gdy będzie wykonany.': '✅ Workout without video added to the list. Check the box when it is done.',
            '✅ Bieg zapisany i dodany do workoutów!': '✅ Run saved and added to workouts!',
            '⚠️ Wpisz nazwę treningu!': '⚠️ Enter workout name!',
            '✅ Własne ćwiczenie dodane!': '✅ Custom exercise added!',
            'Własne ćwiczenie dodane!': 'Custom exercise added!',
            'Zapisz bieg': 'Save run',
            'Zakończone': 'Done',
        ...
        'it': {
            ...
            'Witaj ponownie!': 'Bentornata!',
            'Seria': 'Serie',
            'Dzień': 'Giorno',
            'Odznak': 'Badge',
            'Zaatakuj dzień!': 'Affronta la giornata!',
            'Zapisz i zacznij dzień': 'Salva e inizia la giornata',
            'Twoja odpowiedź...': 'La tua risposta...',
            'słów': 'parole',
            '⚠️ Refleksja może mieć maksymalnie 100 słów.': '⚠️ Una riflessione può avere al massimo 100 parole.',
            'Status': 'Stato',
            'Zadania': 'Compiti',
            'tak': 'sì',
            'nie': 'no',
            'Refleksja': 'Riflessione',
            'Zapisz refleksję': 'Salva riflessione',
            'Anuluj': 'Annulla',
            'Nie masz jeszcze zapisanych wcześniejszych wyzwań.': 'Non hai ancora sfide archiviate.',
            'dni': 'giorni',
            'Najlepszy streak': 'Migliore serie',
            'Refleksje': 'Riflessioni',
            'Usuń z archiwum': 'Elimina dall\'archivio',
            'Usunąć to wyzwanie z archiwum?': 'Eliminare questa sfida dall\'archivio?',
            'ukończony': 'completato',
            'częściowy': 'parziale',
            'odpoczynek': 'riposo',
            'nieudany': 'mancato',
            '🎯 Wyzwanie': '🎯 Sfida',
            ...
            'Wyzwanie': 'Sfida',
            'Regularność buduje mocny postęp. Każdy dzień robi różnicę, gdy masz plan i widoczny wynik.': 'La costanza crea un vero slancio. Ogni giorno fa la differenza quando hai un piano e risultati visibili.',
            ...
            'Dni, które minęły': 'Giorni trascorsi',
            ...
            'dni': 'giorni',
            'Trening bez filmu': 'Allenamento senza video',
            'Dodaj trening': 'Aggiungi allenamento',
            'Zaznacz checkbox, gdy będzie wykonany.': 'Seleziona la casella quando è stato completato.',
            'Bieg / aktywność bez filmu': 'Corsa / attività senza video',
            'Dystans:': 'Distanza:',
            'Czas:': 'Tempo:',
            'Np. Bieg 5 km, interwały, rower...': 'Es. corsa da 5 km, intervalli, bici...',
            'Wpisz nazwę treningu!': 'Inserisci il nome dell\'allenamento!',
            'Wpisz dystans lub czas biegu': 'Inserisci distanza o tempo di corsa',
            'Bieg zapisany i dodany do workoutów!': 'Corsa salvata e aggiunta agli allenamenti!',
            'Trening bez filmu dodany do listy. Zaznacz checkbox, gdy będzie wykonany.': 'Allenamento senza video aggiunto alla lista. Seleziona la casella quando è stato completato.',
            ...
            '✅ Trening bez filmu dodany do listy. Zaznacz checkbox, gdy będzie wykonany.': '✅ Allenamento senza video aggiunto alla lista. Seleziona la casella quando è stato completato.',
            '✅ Bieg zapisany i dodany do workoutów!': '✅ Corsa salvata e aggiunta agli allenamenti!',
            '⚠️ Wpisz nazwę treningu!': '⚠️ Inserisci il nome dell\'allenamento!',
            '✅ Własne ćwiczenie dodane!': '✅ Esercizio personalizzato aggiunto!',
            'Zapisz bieg': 'Salva corsa',
            'Zakończone': 'Completato',
            'Trening': 'Allenamento',
            'Własne ćwiczenie': 'Esercizio personalizzato',
            'Treningi': 'Allenamenti',
            'Dodaj pierwszy film lub własne ćwiczenie, aby rozpocząć plan treningowy na dziś.': 'Aggiungi il tuo primo video o esercizio personalizzato per iniziare il piano di allenamento di oggi.',
            'Wszystkie treningi z YouTube i własne zadania są teraz w jednej, czytelnej sekcji z odznaką „wykonane dziś”.': 'Tutti gli allenamenti YouTube e i compiti personalizzati sono ora in un\'unica sezione chiara con il badge “fatto oggi”.',
            'Poniedziałek': 'Lunedì',
            'Wtorek': 'Martedì',
    ...
    const badgeMeta = {
        ...
        'first-task': { icon: '🌱', name: { pl: 'Pierwsze zadanie', en: 'First task', it: 'Primo compito' }, description: { pl: 'Ukończ pierwsze zadanie', en: 'Complete your first task', it: 'Completa il tuo primo compito' } },
        ...
        'study-starter': { icon: '📚✨', name: { pl: 'Pierwsza lekcja', en: 'First lesson', it: 'Prima lezione' }, description: { pl: 'Zapisz pierwszą sesję nauki', en: 'Log your first study session', it: 'Registra la tua prima sessione di studio' } },
        'study-scholar': { icon: '🎓📖', name: { pl: 'Wiedza rośnie', en: 'Knowledge grows', it: 'La conoscenza cresce' }, description: { pl: 'Zapisz łącznie 10 godzin nauki', en: 'Log 10 study hours in total', it: 'Registra 10 ore di studio in totale' } },
        ...
        'challenge-named': { icon: '✍️✨', name: { pl: 'Po swojemu', en: 'Your own way', it: 'A modo tuo' }, description: { pl: 'Nadaj wyzwaniu własną nazwę', en: 'Give your challenge a custom name', it: 'Dai alla tua sfida un nome personale' } },
    ...
    function translateOptions(language) {
        ...
        if (themeSelect) {
            const optionMap = {
                ...
                aurora: { pl: 'Aurora ✨', en: 'Aurora ✨', it: 'Aurora ✨' },
                'peach-pop': { pl: 'Peach Pop 🍑', en: 'Peach Pop 🍑', it: 'Peach Pop 🍑' },
